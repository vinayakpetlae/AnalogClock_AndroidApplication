...
public class SharedColorPreferenceHands extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shared_color_preference_hands);
    ...
    public void red(View view) {
        ...
        preferences.edit().putInt("color1", colorId).apply();
    ...
    public void blue(View view) {
        ...
        SharedPreferences preferences = getSharedPreferences("MYPREFS", MODE_PRIVATE);
        preferences.edit().putInt("color1", colorId1).apply();
